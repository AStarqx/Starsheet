...
function rightclickHTML() {
    ...
    const conditionformat = _locale.conditionformat;
    ...
    const customsButtons = (config.customs || [])
        .map(
            (item, index) => `
            <div data-showProp="${item.showProp}" data-index="${index}" class="luckysheetColsRowsHandleAdd_custom luckysheet-cols-menuitem luckysheet-mousedown-cancel">
    ...
    const rightclickContainer = `<div id="luckysheet-rightclick-menu" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel">
        ...
        rightclick.column
                ...
                <div id="luckysheet-cols-rows-add">
                    ...
                    <div id="luckysheet-column-row-width-selected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            ...
                            <input type="number" class="luckysheet-mousedown-cancel rcsize" min="0" max="255" step="0.1" placeholder="${
                                rightclick.number
                            }" value="" style="width:60px;height:20px;box-sizing:border-box;text-align: center;margin-left:5px;">
                            cm
                        </div>
                    </div>
                </div>
                ...
                <div id="luckysheet-cols-rows-data">
                    ...
                    <div id="luckysheetResetPrintArea" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel" style="display:${config.resetPrintArea ? 'block' : 'none'};">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${toolbar.resetPrintArea}</div>
                    </div>
                    <div id="luckysheetDefinedFields" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel" style="display:${config.definedFields ? 'block' : 'none'};">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${conditionformat.definedFields}</div>
                    </div>
