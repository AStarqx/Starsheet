...
import { luckysheet_searcharray, luckysheet_searcharrayX } from "../controllers/sheetSearch";
...
export function rowColumnOperationInitial() {
    ...
    $("#luckysheet-del-selected, #luckysheet-del-selected_t").click(function(event) {
        ...
        if(!method.createHookFunction("rowDeleteBefore", st_index, ed_index, Store.luckysheetRightHeadClickIs, Store.flowdata)){
        	return; 
    ...
    $("#luckysheet-column-row-width-selected").click(function(event) {
        ...
        size = parseFloat(size * 96 / 2.54).toFixed(1);
...
function luckysheetrowsdbclick() {
    ...
    $("#luckysheet-change-size-line").hide();
    $("#luckysheet-rows-change-size").css("opacity", 0);
    $("#luckysheet-sheettable, #luckysheet-rows-h canvas").css(
        "cursor",
        "default",
    );
