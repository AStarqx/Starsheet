...
export const toolbarIdMap = {
    ...
    importXlsx: '#luckysheet-importXlsx-btn-title', // 'import xlsx'
        ...
        data-tips="${toolbar.importXlsxTips}" id="luckysheet-importXlsx-btn-title" role="button" style="user-select: none;">
            ...
            style="user-select: none;">
                ...
                style="user-select: none;">
                    ...
                    style="user-select: none;">
                        <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                            <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none iconfont-luckysheet luckysheet-iconfont-daoru"
                            style="user-select: none;">
                                ...
                                <input id="luckysheet-xlsxUpload" type="file" accept=".xls,.xlsx" style="display:none;"></input>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        data-tips="${toolbar.exportXlsx}" id="luckysheet-exportXlsx-btn-title" role="button" style="user-select: none;">
            ...
            style="user-select: none;">
                ...
                style="user-select: none;">
                    ...
                    style="user-select: none;">
                        <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                            <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none iconfont-luckysheet luckysheet-iconfont-daochu"
                            style="user-select: none;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><path d="M4 12a8 8 0 1 0 16 0"/><path stroke-linejoin="round" d="M12 14V4m0 0l3 3m-3-3L9 7"/></g></svg>
                            </div>
                        </div>
