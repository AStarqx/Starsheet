...
luckysheet.create = function (setting) {
    ...
    Store.isRefreshConfig = extendsetting.isRefreshConfig;
    ...
    luckysheetConfigsetting.exportFileName = extendsetting.exportFileName;
