...
var LuckySheet = /** @class */ (function (_super) {
    ...
    function LuckySheet(sheetName, sheetId, sheetOrder, isInitialCell, allFileOption) {
        ...
        if (sheetView.length > 0) {
            ...
            if (panes != null && panes.length > 0) {
                ...
                if (type) {
                    _this.frozen = { type: type, range: range };
                }
            }
        }
    ...
    */
    ...
    LuckySheet.prototype.getSheetBysheetName = function (name) {
        var sheet = this.sheets.find(function (s) { return s.attributeList.name === name; });
        if (!sheet)
            return;
        return sheet;
    };
    ...
    */
    ...
    LuckySheet.prototype.generateConfigDataValidations = function () {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            var operator = "", sqref = "", sqrefIndexArr = [], formulaValueArr = [], valueArr = [];
            ...
            if (formulaReg.test(formulaValue) && (extLst === null || extLst === void 0 ? void 0 : extLst.length) >= 0) {
                ...
                formulaValueArr = getMultiFormulaValue(peelOffData === null || peelOffData === void 0 ? void 0 : peelOffData.formula);
...
var LuckyFile = /** @class */ (function (_super) {
    ...
    */
    LuckyFile.prototype.getSheetsFull = function (isInitialCell) {
        ...
        var definedNames = this.readXml.getElementsByTagName("definedNames/definedName", workBookFile);
        var sheetList = {};
