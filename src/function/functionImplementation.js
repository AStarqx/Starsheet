    ...
    "MATCH": function() {
        ...
        try {
            ...
            for (var idx = 0; idx < lookup_array.length; idx++) {
                // 查找小于或等于look_value的最大值 lookup_array 参数中的值必须以升序排序
                if (match_type === 1) {
                ...
                // 查找完全等于 lookup_value 的第一个值 lookup_array 参数中的值可按任何顺序排列
                ...
                // 查找大于或等于 lookup_value 的最小值 lookup_array 参数中的值必须按降序排列
